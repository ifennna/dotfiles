  ...
  let s:guishade1 = "#16161c"
  let s:guishade2 = "#6c6f93"
  let s:guishade3 = "#6c6f93"
  let s:guishade4 = "#2e303e"
  let s:guishade5 = "#fdf0ed"
  let s:guishade6 = "#fdf0ed"
  let s:guishade7 = "#fdf0ed"
  let s:guiaccent0 = "#e95678"
  let s:guiaccent1 = "#fab795"
  let s:guiaccent2 = "#fbc3a7"
  let s:guiaccent3 = "#29d398"
  let s:guiaccent4 = "#59e3e3"
  let s:guiaccent5 = "#26bbd9"
  let s:guiaccent6 = "#ee64ae"
  let s:guiaccent7 = "#f075b7"
